...
public class TransactionStatusUpdate {
    ...
    public void update(NchlReconciled reconciled) {
        try {
            ...
            if (debitStatus.equals("000") && status.equalsIgnoreCase("999")) {
            ...
            } else if (!debitStatus.equals("000") && !debitStatus.equals("ENTR")) {
                if (status.equals("1000") || status.equals("909") || status.equals("096") || status.equals("1001")) {
                    updateFailureStatus(reconciled.getCreditMessage() + " " + reconciled.getDebitMessage(), instructionId);
                } else {
